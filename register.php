...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Registrar || Ruan Lanches</title>
        ...
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Ruan" name="fname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Lopes" name="lname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Av das Torres" name="address">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Lages" name="city">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="emailteste@gmail.com" name="email">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">

...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Minha conta || Ruan Lanches</title>
  ...
  <body>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        ...
        <p>Abaixo estão sua informações mantidas no banco de dados da empresa, se mudar algo, clique no atualizar.</p>
      </div>
    </div>
            ...
            <div class="small-8 columns end">
              <?php
                ...
                if($result) {
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">CEP</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';

...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Administrador || Ruan Lanches</title>
  ...
  <body>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        <center><p><input style="clear:both;" type="submit" class="button" value="Atualizar"></p></center>
        </form>

...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Contato || Ruan Lanches</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <!-- Right Nav Section -->
        <ul class="right">
          ...
          <li class="active"><a href="contact.php">Reclame Aqui</a></li>
          <?php
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        ...
        <p>Envie um e-mail para nós <a href="mailto:emailteste@teste.com">emailteste@teste.com</a></p>
